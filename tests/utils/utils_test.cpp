...
static void CompareTimestamps(const aos::Time& lhs, const google::protobuf::Timestamp& rhs)
{
...
TEST_F(UtilsTest, ConvertNodeMonitoringDataToProto)
{
    ...
    aos::sm::utils::ConvertToProto(param, *result.mutable_node_monitoring(), *result.mutable_instances_monitoring());
...
TEST_F(UtilsTest, ConvertOverrideEnvVarsToAosSucceeds)
{
    ...
    auto err = aos::sm::utils::ConvertToAos(param, result);
...
TEST_F(UtilsTest, ConvertOverrideEnvVarsToAosReturnsErrorOnInstanceEnvVarLimitExceeded)
{
    ::servicemanager::v4::OverrideEnvVars param;
...
TEST_F(UtilsTest, ConvertOverrideEnvVarsToAosReturnsErrorOnInstancesLimitExceeded)
{
    ::servicemanager::v4::OverrideEnvVars param;
...
TEST_F(UtilsTest, ConvertSystemLogRequestToAos)
{
...
TEST_F(UtilsTest, ConvertInstanceLogRequestToAos)
{
...
TEST_F(UtilsTest, ConvertInstanceCrashLogRequestToAos)
{
...
TEST_F(UtilsTest, ConvertCoreAlertToProto)
{
    aos::Time expectedTimestamp = aos::Time::Now();
...
TEST_F(UtilsTest, ConvertSystemQuotaAlertToProto)
{
    aos::Time expectedTimestamp = aos::Time::Now();
...
TEST_F(UtilsTest, ConvertInstanceQuotaAlertToProto)
{
    aos::Time expectedTimestamp = aos::Time::Now();
...
TEST_F(UtilsTest, ConvertDeviceAllocateAlertToProto)
{
    aos::Time expectedTimestamp = aos::Time::Now();
...
TEST_F(UtilsTest, ConvertResourceValidateAlertToProto)
{
    aos::Time  expectedTimestamp = aos::Time::Now();
...
TEST_F(UtilsTest, ConvertDownloadAlertToProto)
{
    aos::Time expectedTimestamp = aos::Time::Now();
...
TEST_F(UtilsTest, ConvertServiceInstanceAlertToProto)
{
    aos::Time expectedTimestamp = aos::Time::Now();
